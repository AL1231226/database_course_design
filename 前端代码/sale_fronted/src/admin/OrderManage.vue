  ...
  <div class="order-manage">
    ...
    <table class="table">
      ...
      <tbody>
        <tr v-for="o in orders" :key="o.orderId">
          ...
          <td>{{ o.orderDate }}</td>
          <td>{{ o.totalAmount != null ? o.totalAmount : totalAmount(o) }} 元</td>
          ...
          <td class="actions">
            ...
            <button class="btn btn-warning" v-if="o.supplyStatus === 'available' && o.paymentStatus === 'unpaid'"
              @click="handlePay(o)">标记付款</button>
          </td>
        </tr>
      </tbody>
    </table>
    ...
    <div class="modal" v-if="detail">
      <div class="modal-content">
        ...
        <p style="margin-top:12px;text-align:right;font-size:18px;font-weight:bold">合计（含运费）：{{ detail.totalAmount != null ? detail.totalAmount : totalAmount(detail) }} 元</p>
      </div>
    </div>
  </div>
</template>
